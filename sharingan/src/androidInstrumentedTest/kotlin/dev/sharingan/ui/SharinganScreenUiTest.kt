...
internal class SharinganScreenUiTest {
    ...
    private fun seededStore(): SharinganStore =
        SharinganStore().apply {
            record(
                HttpEvent(
                    id = "h1",
    ...
    @Test
    fun homeTab_showsHttpRowsWithStatusAndCount() =
        runComposeUiTest {
    ...
    @Test
    fun errorsChip_filtersToFailuresOnly() =
        runComposeUiTest {
            setContent { SharinganScreen(store = seededStore()) }
    ...
    @Test
    fun mqttTab_showsDescriptorChipsAndRows() =
        runComposeUiTest {
            setContent { SharinganScreen(store = seededStore()) }
    ...
    @Test
    fun rowTap_opensDetailWithSummaryAndBody_backReturnsHome() =
        runComposeUiTest {
            setContent { SharinganScreen(store = seededStore()) }
    ...
    @Test
    fun shareSheet_offersAgentCopyFirstAndCurlForSingleHttp() =
        runComposeUiTest {
            setContent { SharinganScreen(store = seededStore()) }
    ...
    @Test
    fun copyForAgent_showsToastThatAutoDismisses() =
        runComposeUiTest {
            setContent { SharinganScreen(store = seededStore()) }
    ...
    @Test
    fun recPill_pausesCaptureAndShowsPausedState() =
        runComposeUiTest {
