...
internal object PreviewData {
    val http =
        listOf(
            HttpEvent(
                id = "h1",
                timestampMillis = 1_749_556_771_882,
                method = "GET",
                ...
                timing =
                    listOf(
                        TimingPhase("DNS", 8),
                        TimingPhase("Connect", 21),
                        TimingPhase("TLS", 34),
                        TimingPhase("TTFB", 71),
                        TimingPhase("Download", 8),
                    ),
            ),
            HttpEvent(
                id = "h2",
                timestampMillis = 1_749_556_773_201,
                method = "POST",
                url = "https://api.acme-iot.com/api/v2/devices/4471/commands",
                statusCode = 202,
                durationMillis = 96,
                responseSizeBytes = 312,
            ...
            HttpEvent(
                id = "h3",
                timestampMillis = 1_749_556_780_118,
                method = "POST",
            ...
            HttpEvent(
                id = "h4",
                timestampMillis = 1_749_556_782_455,
                method = "GET",
    ...
    val mqtt =
        listOf(
            MqttEvent(
                id = "m1",
                timestampMillis = 1_749_556_773_114,
                direction = MqttDirection.PUBLISH,
                topic = "devices/4471/telemetry",
                qos = 1,
                payload = """{"temp":23.4,"hum":48,"ts":1749556800}""",
                payloadSizeBytes = 24,
            ),
            MqttEvent(
                id = "m2",
                timestampMillis = 1_749_556_773_120,
                direction = MqttDirection.SUBSCRIBE,
                topic = "devices/4471/commands/#",
                qos = 1,
            ),
            MqttEvent(
                id = "m3",
                timestampMillis = 1_749_556_775_441,
            ...
            MqttEvent(
                id = "m4",
                timestampMillis = 1_749_556_779_233,
                direction = MqttDirection.PUBLISH,
    ...
    val ble =
        listOf(
            BleEvent(
                id = "b1",
                timestampMillis = 1_749_556_770_120,
                operation = BleOperation.CONNECT,
                device = "C8:3A:35:9F:01:22",
                characteristic = "HR-Monitor-9F",
                payload = """{"event":"GATT connected","mtu":185,"rssi":-58}""",
            ),
            BleEvent(
                id = "b2",
                timestampMillis = 1_749_556_770_551,
                operation = BleOperation.NOTIFY,
                device = "HR-Monitor-9F",
                characteristic = "Heart Rate Measurement",
                uuid = "0x2A37",
                payload = """{"flags":"0x06","bpm":72,"raw":"06 48 00 12 03"}""",
                sizeBytes = 8,
            ),
            BleEvent(
                id = "b3",
                timestampMillis = 1_749_556_771_002,
                operation = BleOperation.READ,
                device = "HR-Monitor-9F",
                characteristic = "Battery Level",
                uuid = "0x2A19",
                payload = """{"raw":"0x5C","battery":92}""",
                sizeBytes = 1,
            ),
            BleEvent(
                id = "b4",
                timestampMillis = 1_749_556_773_120,
                operation = BleOperation.ERROR,
                device = "HR-Monitor-9F",
...
internal fun previewCounts(): Map<Protocol, Int> =
    mapOf(
